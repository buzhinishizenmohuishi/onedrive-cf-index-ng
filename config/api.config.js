...
模块。出口= {
  ...
  // 如果您可以使用OneDrive International的个人微软账户进行身份验证，则需在此处进行任何更改。
  ...
  // 同样，如果您使用 OneDrive International 的个人微软账户，则需要更改redirectUri。
  redirectUri : 'http://localhost' ,

  // 这些是 OneDrive API 端点的 URL。如果您使用的是 OneDrive International，则需在此处进行任何更改
  ...
  // Cache-Control 标头，请查看 Vercel 文档以获取更多详细信息。默认设置意义：
